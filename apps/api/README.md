...
Set `CORS_ORIGINS` to the comma-separated HTTPS origins of the deployed
frontend. Keep `OPENAI_API_KEY` in the hosting provider's secret store; it is
optional because the rule-based diagnosis fallback works without it.
